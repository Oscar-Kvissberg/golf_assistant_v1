      ...
      <div className="container mx-auto px-4 relative">
        <div className="flex flex-col items-center justify-center min-h-screen text-center">
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
            E-post <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Assistent</span> med AI
          </h1>
          
          <p className="text-xl text-gray-600 max-w-2xl mb-12">
            Öka din produktivitet med vår e-postassistent. 
            Generera professionella och tydligasvar snabbt och enkelt.
          </p>
          ...
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg max-w-3xl w-full">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-sm text-gray-500">name@catalinasoftwaresolutions.se</div>
            </div>
            <div className="bg-gray-50/80 backdrop-blur-sm rounded-lg p-4 text-left">
              <p className="text-gray-700 font-mono h-6">
                <Typewriter 
                  text="Låt AI:n hjälpa dig att skriva professionella e-postsvar på sekunder..." 
                  delay={40}
                  restartDelay={2000}
                />
              </p>
